...
public class UserAdminController {
    ...
    public ResponseEntity getUsers(@PathVariable String appkey, @RequestHeader String token){
    ...
    public ResponseEntity addUsers(@PathVariable String appkey, @RequestHeader String token, @RequestBody String requestBody){
